...
// SuperJump
//=============================================================================
class SuperJump extends TournamentPickup;
...
Begin:
    ...
    Pawn(Owner).JumpZ = Pawn(Owner).Default.JumpZ * 9+Charge;
...
defaultproperties
{
     ExpireMessage="The Super Jump Boots have drained."
     bAutoActivate=True
     bActivatable=True
     bDisplayableInv=True
     PickupMessage="You picked up the Super Jump Boots."
     ItemName="Super Jump Boots"
