...
var int	InfoKill, InfoBuild, InfoWarheadBuild, InfoWarheadDestroy, InfoWarheadFail, InfoMineFrag, InfoPlayerCoreDmg;
...
function UpdateData()
{
	...
	PRI.sgInfoCoreDmg = InfoPlayerCoreDmg;
	Team = PRI.Team;
	RU = PRI.RU;
	Score = PRI.Score;
	Deaths = PRI.Deaths;
...
{
	InfoPlayerCoreDmg =  int(InfoPlayerCoreDmg + Change);
}
